...
<div id="header"></div>
    <div class="signin">
        <form action="showprice.jsp" method="post">  
...
<%
	...
	boolean st = false;
			...
			Connection conn = DriverManager
                   ...
                   ResultSet rs= st1.executeQuery("select * from cdata");
                      
%>         
FROM :<br> <select class="select-css" name="from">
<%
while(rs.next())
	{
	%>                   
...
%>         
TO : <br> <select class="select-css" name="to">
<%
while(rs.next())
	{
	%>                   
