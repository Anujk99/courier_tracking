...
<div id="header"></div>
    <div class="signin">
        <form action="updatestatus.jsp" method="post">  
                <h1>Update Current Status</h1>
                <p id="p1"></p>
                <input type="text" name="id" id="demo" value="" onClick=fun2() placeholder="Tracking Id"><br><br>
                <p2 id="p2"></p2><center>
                <input type="date" name="date1" id="demo1" onclick="fun2()" placeholder="Update Date"><br><br>
                <p3 id="p3"></p3></center>
                <input type="text" name="l" id="demo1" onclick="fun2()" placeholder="Current Location"><br><br>
                <p3 id="p3"></p3>
